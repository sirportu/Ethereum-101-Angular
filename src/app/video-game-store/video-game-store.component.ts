...
@Component({
  selector: 'app-video-game-store',
  templateUrl: './video-game-store.component.html',
  styleUrls: ['./video-game-store.component.css']
})
export class VideoGameStoreComponent implements OnInit {
  ...
  ownerAddress = null;
  contractABI = abi.abi;
  contractAddress = environment.contract_address_vgs;
  gameList: string[] = [];
  gameMyList: string[] = [];
